...
function CountWithReducer() {
  ...
  return (
    <div>
      ...
      <button onClick={()=> dispatch ('minusOne')} >Minus 1</button>
      <button onClick={()=> dispatch ('reset')} >Reset</button>
    
    <h4> we have created same app and receiving same output <br />
    but with more cleaner code and without having more handler  </h4>
    </div>
  );
}
